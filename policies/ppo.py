...
class PPOPolicy(Policy, BaseModelMixin):
    ...
    def act(self, state, **kwargs):
        # something weird about probas
        # opposite thing happened in actor-critic
        # expected to return ex: [[0.33, 0.67]]
        # but returned [[[0.33, 0.67]]]
    ...
    def _build_train_ops(self):
        ...
        with tf.variable_scope('summary'):
            ...
            self.merged_summary = tf.compat.v1.summary.merge_all(key=tf.GraphKeys.SUMMARIES)
